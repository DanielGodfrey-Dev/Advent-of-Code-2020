function questions(data) {
    ...
    let groupMember = 0;
      ...
      function groupCount() {
        ...
        //establish alphabet set of boolean answers
        let answers = {
          a: false,
          b: false,
          c: false,
        ...
        while (data[groupMember]) {
          //iterate through group member data checking against boolean set
          for (let i = 0; i < data[groupMember].length; i++) {
            //if false, mark true and tick count by one
            if (answers[data[groupMember][i]] === false) {
              answers[data[groupMember][i]] = true;
              count++;
            } else {
            //if true, continue
            continue;
